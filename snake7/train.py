...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train PPO+LSTM agent for Snake (sb3_contrib.RecurrentPPO).")
    ...
    p.add_argument("--model-out", type=Path, default=Path("snake_ppo_lstm.zip"))
